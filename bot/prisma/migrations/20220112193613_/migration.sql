/*
  ...
  - You are about to drop the column `seedCount` on the `Server` table. All the data in the column will be lost.
  - You are about to drop the column `coreCount` on the `User` table. All the data in the column will be lost.
  - You are about to drop the column `seedCount` on the `User` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Server" DROP COLUMN "seedCount",
ADD COLUMN     "currencyCount" INTEGER NOT NULL DEFAULT 0;

-- AlterTable
ALTER TABLE "User" DROP COLUMN "coreCount",
DROP COLUMN "seedCount",
ADD COLUMN     "botCurrencyCount" INTEGER NOT NULL DEFAULT 0,
ADD COLUMN     "serverCurrencyCount" INTEGER NOT NULL DEFAULT 0;
