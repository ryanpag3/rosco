/*
  ...
  - You are about to drop the `_ScoreToScoreboard` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "_ScoreToScoreboard" DROP CONSTRAINT "_ScoreToScoreboard_A_fkey";

-- DropForeignKey
ALTER TABLE "_ScoreToScoreboard" DROP CONSTRAINT "_ScoreToScoreboard_B_fkey";
...
-- DropTable
DROP TABLE "_ScoreToScoreboard";

-- CreateTable
CREATE TABLE "ScoreboardScore" (
    "id" TEXT NOT NULL,
    "scoreboardId" TEXT NOT NULL,
    "scoreId" TEXT NOT NULL,

    CONSTRAINT "ScoreboardScore_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "ScoreboardScore" ADD CONSTRAINT "ScoreboardScore_scoreId_fkey" FOREIGN KEY ("scoreId") REFERENCES "Score"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ScoreboardScore" ADD CONSTRAINT "ScoreboardScore_scoreboardId_fkey" FOREIGN KEY ("scoreboardId") REFERENCES "Scoreboard"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
