/*
  ...
  - A unique constraint covering the columns `[name,serverId,isOpen]` on the table `Poll` will be added. If there are existing duplicate values, this will fail.
...
*/
-- DropForeignKey
ALTER TABLE "Poll" DROP CONSTRAINT "Poll_serverId_fkey";
...
-- DropIndex
DROP INDEX "Poll_name_serverId_isOpen_key";
...
-- CreateIndex
CREATE UNIQUE INDEX "Poll_name_serverId_isOpen_key" ON "Poll"("name", "serverId", "isOpen");
