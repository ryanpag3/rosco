/*
  ...
  - Added the required column `userId` to the `PollVote` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "PollVote" ADD COLUMN     "userId" TEXT NOT NULL;
