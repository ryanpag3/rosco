/*
  ...
  - You are about to drop the column `bannedWordId` on the `AutoModRule` table. All the data in the column will be lost.
  ...
  - Added the required column `module` to the `AutoModRule` table without a default value. This is not possible if the table is not empty.

*/
-- DropForeignKey
ALTER TABLE "AutoModRule" DROP CONSTRAINT "AutoModRule_bannedWordId_fkey";
...
-- AlterTable
ALTER TABLE "AutoModRule" DROP COLUMN "bannedWordId",
