...
-- AlterTable
ALTER TABLE "Server" ADD COLUMN     "announceEnabled" BOOLEAN NOT NULL DEFAULT true,
ADD COLUMN     "autoModBannedWordsEnabled" BOOLEAN NOT NULL DEFAULT false,
ADD COLUMN     "currencyEnabled" BOOLEAN NOT NULL DEFAULT true,
ADD COLUMN     "keywordEnabled" BOOLEAN NOT NULL DEFAULT true,
ADD COLUMN     "pollEnabled" BOOLEAN NOT NULL DEFAULT true,
ADD COLUMN     "scoreEnabled" BOOLEAN NOT NULL DEFAULT true,
ADD COLUMN     "scoreboardEnabled" BOOLEAN NOT NULL DEFAULT true,
ADD COLUMN     "stopwatchEnabled" BOOLEAN NOT NULL DEFAULT true,
