/*
  ...
  - Added the required column `action` to the `CurrencyRule` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "CurrencyRule" ADD COLUMN     "action" "CurrencyAction" NOT NULL;
