/*
  ...
  - You are about to drop the column `serverCurrencyCount` on the `User` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "User" DROP COLUMN "serverCurrencyCount";
...
-- AddForeignKey
ALTER TABLE "UserServer" ADD CONSTRAINT "UserServer_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
