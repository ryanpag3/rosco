...
CREATE TABLE "AllowedLink" (
    ...
    CONSTRAINT "AllowedLink_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "AllowedLink" ADD CONSTRAINT "AllowedLink_serverId_fkey" FOREIGN KEY ("serverId") REFERENCES "Server"("id") ON DELETE CASCADE ON UPDATE CASCADE;
