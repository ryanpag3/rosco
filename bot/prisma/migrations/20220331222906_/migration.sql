/*
  ...
  - A unique constraint covering the columns `[scoreboardId,scoreId]` on the table `ScoreboardScore` will be added. If there are existing duplicate values, this will fail.
...
*/
-- DropForeignKey
ALTER TABLE "ScoreboardScore" DROP CONSTRAINT "ScoreboardScore_scoreId_fkey";

-- DropForeignKey
ALTER TABLE "ScoreboardScore" DROP CONSTRAINT "ScoreboardScore_scoreboardId_fkey";
...
-- DropIndex
DROP INDEX "ScoreboardScore_scoreboardId_scoreId_key";
...
-- CreateIndex
CREATE UNIQUE INDEX "ScoreboardScore_scoreboardId_scoreId_key" ON "ScoreboardScore"("scoreboardId", "scoreId");
...
-- AddForeignKey
ALTER TABLE "ScoreboardScore" ADD CONSTRAINT "ScoreboardScore_scoreId_fkey" FOREIGN KEY ("scoreId") REFERENCES "Score"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "ScoreboardScore" ADD CONSTRAINT "ScoreboardScore_scoreboardId_fkey" FOREIGN KEY ("scoreboardId") REFERENCES "Scoreboard"("id") ON DELETE CASCADE ON UPDATE CASCADE;
