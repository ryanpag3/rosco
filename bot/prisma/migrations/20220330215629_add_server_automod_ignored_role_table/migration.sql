...
-- CreateTable
CREATE TABLE "ServerAutoModIgnoredRole" (
    "id" TEXT NOT NULL,
    "serverId" TEXT NOT NULL,
    "roleId" TEXT NOT NULL,

    CONSTRAINT "ServerAutoModIgnoredRole_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "ServerAutoModIgnoredRole" ADD CONSTRAINT "ServerAutoModIgnoredRole_serverId_fkey" FOREIGN KEY ("serverId") REFERENCES "Server"("id") ON DELETE CASCADE ON UPDATE CASCADE;
