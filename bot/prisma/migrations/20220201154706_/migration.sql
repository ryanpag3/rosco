/*
  ...
  - You are about to drop the column `days` on the `Timer` table. All the data in the column will be lost.
  - You are about to drop the column `hours` on the `Timer` table. All the data in the column will be lost.
  - You are about to drop the column `minutes` on the `Timer` table. All the data in the column will be lost.
  - You are about to drop the column `seconds` on the `Timer` table. All the data in the column will be lost.
  ...
  - Added the required column `expiresOn` to the `Timer` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Timer" DROP COLUMN "days",
DROP COLUMN "hours",
DROP COLUMN "minutes",
DROP COLUMN "seconds",
