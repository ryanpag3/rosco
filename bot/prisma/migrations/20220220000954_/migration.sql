...
CREATE TABLE "AutoModRule" (
    ...
    "cooldownPeriodSecs" INTEGER NOT NULL,
    "bannedWordId" TEXT,
...
-- CreateTable
CREATE TABLE "AutoModRuleUser" (
    "id" TEXT NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
    "userId" TEXT NOT NULL,
    "autoModRuleId" TEXT NOT NULL,
    "currentViolations" INTEGER NOT NULL,
    "cooldownExpiresOn" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "AutoModRuleUser_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "AutoModRule" ADD CONSTRAINT "AutoModRule_bannedWordId_fkey" FOREIGN KEY ("bannedWordId") REFERENCES "BannedWord"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AutoModRuleUser" ADD CONSTRAINT "AutoModRuleUser_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "AutoModRuleUser" ADD CONSTRAINT "AutoModRuleUser_autoModRuleId_fkey" FOREIGN KEY ("autoModRuleId") REFERENCES "AutoModRule"("id") ON DELETE CASCADE ON UPDATE CASCADE;
