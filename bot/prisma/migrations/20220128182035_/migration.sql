...
-- AlterTable
ALTER TABLE "Server" ADD COLUMN     "privateWelcomeMessage" TEXT,
ADD COLUMN     "privateWelcomeMessageEnabled" BOOLEAN,
ADD COLUMN     "publicWelcomeMessage" TEXT,
ADD COLUMN     "publicWelcomeMessageEnabled" BOOLEAN;
