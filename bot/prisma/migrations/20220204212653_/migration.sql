/*
  ...
  - Added the required column `channelId` to the `Announcement` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Announcement" ADD COLUMN     "channelId" TEXT NOT NULL;
