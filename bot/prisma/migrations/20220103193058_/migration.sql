/*
  ...
  - A unique constraint covering the columns `[commandId,serverId]` on the table `Permission` will be added. If there are existing duplicate values, this will fail.
...
-- DropIndex
DROP INDEX "Permission_commandId_serverId_key";
...
-- CreateIndex
CREATE UNIQUE INDEX "Permission_commandId_serverId_key" ON "Permission"("commandId", "serverId");
