/*
  ...
  - Added the required column `title` to the `ServerWelcomeMessage` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "ServerWelcomeMessage" ADD COLUMN     "title" TEXT NOT NULL;
