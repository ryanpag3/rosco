/*
  ...
  - You are about to drop the column `announcementSent` on the `Timer` table. All the data in the column will be lost.
  ...
  - Added the required column `channelId` to the `Timer` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Timer" DROP COLUMN "announcementSent",
