/*
  ...
  - You are about to drop the column `privateWelcomeMessage` on the `Server` table. All the data in the column will be lost.
  - You are about to drop the column `privateWelcomeMessageChannelId` on the `Server` table. All the data in the column will be lost.
  - You are about to drop the column `privateWelcomeMessageEnabled` on the `Server` table. All the data in the column will be lost.
  - You are about to drop the column `publicWelcomeMessage` on the `Server` table. All the data in the column will be lost.
  - You are about to drop the column `publicWelcomeMessageChannelId` on the `Server` table. All the data in the column will be lost.
  - You are about to drop the column `publicWelcomeMessageEnabled` on the `Server` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "Server" DROP COLUMN "privateWelcomeMessage",
DROP COLUMN "privateWelcomeMessageChannelId",
DROP COLUMN "privateWelcomeMessageEnabled",
DROP COLUMN "publicWelcomeMessage",
DROP COLUMN "publicWelcomeMessageChannelId",
DROP COLUMN "publicWelcomeMessageEnabled";
...
-- AddForeignKey
ALTER TABLE "ServerWelcomeMessage" ADD CONSTRAINT "ServerWelcomeMessage_serverId_fkey" FOREIGN KEY ("serverId") REFERENCES "Server"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
