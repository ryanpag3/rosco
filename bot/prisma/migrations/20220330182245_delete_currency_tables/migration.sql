/*
  ...
  - You are about to drop the `CurrencyHistoryLog` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `CurrencyRule` table. If the table is not empty, all the data it contains will be lost.
...
*/
-- DropForeignKey
ALTER TABLE "CurrencyHistoryLog" DROP CONSTRAINT "CurrencyHistoryLog_currencyRuleId_fkey";
...
-- DropForeignKey
ALTER TABLE "CurrencyHistoryLog" DROP CONSTRAINT "CurrencyHistoryLog_serverId_fkey";

-- DropForeignKey
ALTER TABLE "CurrencyRule" DROP CONSTRAINT "CurrencyRule_serverId_fkey";

-- DropForeignKey
ALTER TABLE "CurrencyRule" DROP CONSTRAINT "CurrencyRule_userId_fkey";
...
-- DropTable
DROP TABLE "CurrencyHistoryLog";

-- DropTable
DROP TABLE "CurrencyRule";
