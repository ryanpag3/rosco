...
it('should decrease the score count', async () => {
    ...
    int = createTestInteraction('score', 'down', {
        name: 'test'
    }, '1');
...
it('should decrease the score count by the designated amount', async () => {
    let int = createTestInteraction('score', 'create', {
        name: 'test',
        description: 'description'
    }, '1');
...
it('should throw an error if a score does not exist', async () => {
    const int = createTestInteraction('score', 'down', {
        name: 'test',
        amount: 100
    }, '1');
